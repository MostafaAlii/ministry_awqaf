...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الفتاوي</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                اضافه فتوي جديد</span>
        </div>
    </div>
    ...
    <div class="col">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                        <p class="text-danger">* صيغة المرفق  mb3</p>
                        <h5 class="card-title">المرفقات</h5>
    
                        <div class="col-sm-12 col-md-12">
                            <input type="file" name="pic" class="dropify" accept=".pdf,.jpg, .png, image/jpeg, image/png,audio" data-height="70" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <button class="btn btn-success">اضافه فتوي جديد</button>
                    </div>
                </div>
