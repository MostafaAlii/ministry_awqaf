    ...
    <div class="col-lg-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                        <textarea class="form-control" disabled rows="5">محتوي </textarea>
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col">
                        <button class="btn btn-success">اضافه ايه جديده</button>
                    </div>
                </div>
            </div>
        </div>
